...
class question:
    ...
    def add_all(self):
        ...
        self.add_question("Pada graph tak berarah, dua simput disebut adjacent ketika", "ada busur yang menghubungkan kedua simpul", "ada simpul yang menghubungkan kedua simpul", "tidak ada busur yang menghubungkan kedua simpul", "ada busur dan simpul yang menghubungkan kedua simpul")#6
